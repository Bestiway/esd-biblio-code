/*
 * Renders animation/index.html to a PNG frame sequence with a transparent
 * background, using the pre-installed Chromium. Frames land in animation/out/frames.
 *
