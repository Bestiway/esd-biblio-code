/*
 * Renders pathway/vertical.html (1080x1920, 9:16) to a transparent PNG
...
const framesDir = join(here, 'out', 'frames-vertical');
...
await page.goto('file://' + join(here, 'vertical.html'));
